 ...
 */
typedef void (*fr_event_fd_handler_t)(fr_event_list_t *el, int fd, int flags, void *uctx);
 ...
 * @param[in] uctx	User ctx passed to #fr_event_fd_insert.
 */
typedef void (*fr_event_fd_error_handler_t)(fr_event_list_t *el, int fd, int flags, int fd_errno, void *uctx);
