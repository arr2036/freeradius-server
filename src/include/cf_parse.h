 ...
 */
#ifndef _FR_CF_PARSE_H
#define _FR_CF_PARSE_H
/**
 * $Id$
 *
 * @file include/cf_parse.h
...
#define		cf_section_rules_push(_cs, _rule) _cf_section_rule_push(_cs, _rule, __FILE__, __LINE__)
